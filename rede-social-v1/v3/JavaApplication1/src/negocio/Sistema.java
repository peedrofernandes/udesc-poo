...
public class Sistema {
  ...
  public void cadastrarUsuario(
    ...
    Usuario novoUsuario = new Usuario(id, email, nomeCompleto, apelido, Seguranca.obterHash(senha));
  ...
  public void editarDadosGeraisUsuario(String email, String nomeCompleto, String apelido, String biografia) throws InvalidEmailException, InvalidNameException, ExistingAliasException, UpdateException {
    ...
    String dataEmail = email != "" ? email : usuarioLogado.getEmail();
    String dataNomeCompleto = nomeCompleto != "" ? nomeCompleto : usuarioLogado.getNomeCompleto();
    String dataApelido = apelido != "" ? apelido : usuarioLogado.getApelido();
    String dataBiografia = biografia != "" ? biografia : usuarioLogado.getBiografia();
  ...
  public boolean novoPost(File foto, String legenda, Date data) {
    if (this.usuarioLogado == null)
      return false;
