  ...
  public Usuario select(int idUsuario) throws SelectException {
    ...
    try {
      ...
      if (result.next()) {
        ...
        Usuario u = new Usuario(id, apelido, email, hashSenha, nomeCompleto, biografia);
        
        u.setSeguidores(selectSeguidores(idUsuario));
        u.setSeguindo(selectSeguidos(idUsuario));
        u.setPosts(selectPosts(idUsuario));
        u.setPostsFavoritos(selectCurtidasPosts(idUsuario));
        u.setConversas(selectConversas(idUsuario));
  ...
  public List<Mensagem> selectMensagensEnviadas(int idUsuario) throws SelectException {
    ...
    try {
      ...
      while (result.next()) {
        ...
        Mensagem m = new Mensagem(id, conversa, null, texto, dataEnvio, visualizado, recebido);
  ...
  public List<Conversa> selectConversas(int idUsuario) throws SelectException {
    ...
    try {
      ...
      while (result.next()) {
        ...
        Conversa conversa = new Conversa(id, null, null, mensagens);
    ...
    try {
      ...
      while (result.next()) {
        try {
          ...
          Post post = new Post(id, null, foto, legenda, dataPublicacao);
  ...
  public List<Mensagem> selectMensagensRecebidas(int idUsuario) throws SelectException {
    ...
    try {
      ...
      while (result.next()) {
        ...
        Conversa conversa = conversaDAO.select(idConversa);
        Usuario autor = this.select(idAutor);
